...
public class ReqOrder {
    ...
    private String delivDate;//配送日期
    private String custName;//退货人
    private String refundDate;//退货时间
    private Integer refundStatue;//退货状态
    private Integer quanTity;//退货数量

    private List<ReqOrderDetail> orderDetails = new ArrayList<>();
    ...
    public void setRefundStatue(Integer refundStatue) {
        this.refundStatue = refundStatue;
    }
    ...
    public void setOrderDetails(List<ReqOrderDetail> orderDetails) {
